...
Security fixes are applied to `main`. Pin deployments to a reviewed commit; do not execute unreviewed role cards, state snapshots, tool schemas, or imported skills from a mutable reference.
